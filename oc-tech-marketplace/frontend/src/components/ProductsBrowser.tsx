            ...
            {products.map((product) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="brand-gradient relative mb-4 h-36 w-full rounded-xl opacity-80">
                    {onSale && (
                      <span className="absolute left-2 top-2 rounded-full bg-red-500 px-2 py-0.5 text-xs font-bold text-white">
                        -{product.active_flash_sale!.discount_percent}%
                      </span>
                    )}
                  </div>
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    <span className="flex items-center gap-2">
                      {onSale && <span className="text-xs text-foreground/40 line-through">${product.base_price}</span>}
