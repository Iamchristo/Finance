    ...
    <div class="mx-auto max-w-6xl flex gap-6 px-4 py-6">
        <aside class="w-48 shrink-0">
            <nav class="flex flex-col gap-1 text-sm">
                <div class="text-xs uppercase text-violet-400 font-semibold mb-2 px-3">Real Estate</div>
                <a href="/dashboard/realestate" class="px-3 py-2 rounded-lg hover:bg-slate-800">Overview</a>
                <a href="/dashboard/realestate/properties" class="px-3 py-2 rounded-lg hover:bg-slate-800">Properties</a>
                <a href="/dashboard/realestate/portfolio" class="px-3 py-2 rounded-lg hover:bg-slate-800">My Portfolio</a>
                <a href="/dashboard/realestate/marketplace" class="px-3 py-2 rounded-lg hover:bg-slate-800">Marketplace</a>
                <a href="/dashboard/realestate/listings" class="px-3 py-2 rounded-lg hover:bg-slate-800">My Listings</a>
            </nav>
        </aside>
