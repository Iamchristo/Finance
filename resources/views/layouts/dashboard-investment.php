    ...
    <div class="mx-auto max-w-6xl flex gap-6 px-4 py-6">
        <aside class="w-48 shrink-0">
            <nav class="flex flex-col gap-1 text-sm">
                <div class="text-xs uppercase text-amber-400 font-semibold mb-2 px-3">Investment</div>
                <a href="/dashboard/investment" class="px-3 py-2 rounded-lg hover:bg-slate-800">Overview</a>
                <a href="/dashboard/investment/plans" class="px-3 py-2 rounded-lg hover:bg-slate-800">Plans</a>
                <a href="/dashboard/investment/subscriptions" class="px-3 py-2 rounded-lg hover:bg-slate-800">My Subscriptions</a>
                <a href="/dashboard/investment/referrals" class="px-3 py-2 rounded-lg hover:bg-slate-800">Referrals</a>
            </nav>
        </aside>
